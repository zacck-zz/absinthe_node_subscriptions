...
const sock = new PhoenixSocket("wss://api.bespiral.io/socket", {
  transport: require('websocket').w3cwebsocket
});
const abSock = AbsintheSocket.create(sock);
const operation = `
...
let notifier = AbsintheSocket.cancel(abSock, {}); // create a new notifier for this operation 
